...
export const dineData = [
    { title: "Pizza Salami", description: "Eine köstliche Pizza mit Salami und Käse.", category: "Pizza", image: "../assets/Pizza.png", vegetarisch: false },
    { title: "Pizza Margherita", description: "Eine klassische Pizza mit Tomaten, Mozzarella und Basilikum.", category: "Pizza", image: "../assets/Pizza.png", vegetarisch: true },
    { title: "Pizza Funghi", description: "Pizza mit Pilzen, Olivenöl und frischem Knoblauch.", category: "Pizza", image: "../assets/Pizza.png", vegetarisch: true },
    { title: "Spaghetti Carbonara", description: "Spaghetti mit einer cremigen Eiersauce, Speck und Parmesankäse.", category: "Pasta", image: "../assets/Pasta.png", vegetarisch: false },
    { title: "Lasagne", description: "Schichtnudeln mit Hackfleisch, Tomatensauce und Käse überbacken.", category: "Pasta", image: "../assets/Pasta.png", vegetarisch: false },
    { title: "Ravioli mit Pesto", description: "Ravioli gefüllt mit Ricotta und Spinat, serviert mit Pesto.", category: "Pasta", image: "../assets/Pasta.png", vegetarisch: true },
    ...
    { title: "Chicken Burger", description: "Hamburger mit knusprig gebratenem Hühnchen, Salat und Mayonnaise.", category: "Burger", image: "../assets/Burger.png", vegetarisch: false },
    ...
    { title: "Sushi Combo", description: "Eine Auswahl an frischem Sushi mit verschiedenen Sorten und Sojasauce.", category: "Sushi", image: "../assets/DS_Logo.png", vegetarisch: false },
    { title: "Sashimi Deluxe", description: "Frische Sashimi-Scheiben von Thunfisch und Lachs.", category: "Sushi", image: "../assets/DS_Logo.png", vegetarisch: false },
